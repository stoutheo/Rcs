...
Rcs has been designed carefully to have only little dependencies. The ones that have been selected are in our opinion very matured libraries:
 ...
 - Libxml2 (MIT License)
 - Qt: LGPL (Also dual commercial license available), specific package: qt4-dev-tools
 - qwt (LGPL with additions), specific libs: libqwt5-qt4-dev and libqwt5-qt4
 - OpenSceneGraph (OSGPL), specific lib: libopenscenegraph-dev
